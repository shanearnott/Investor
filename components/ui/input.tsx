  ...
  ({ className, type, ...props }, ref) => (
    <input
      ...
      className={cn(
        ...
        // Native date inputs render with extra internal padding and an
        // intrinsic min-width in WebKit/Blink; without these overrides
        // they end up visibly taller and wider than text inputs alongside.
        "[&[type=date]]:max-w-[12rem] [&[type=date]]:appearance-none",
        className,
      )}
      {...props}
    />
